...
import random
from model.model_2 import CustomTransformerEncoder
...
val_dataset = CustomDataset(train_df, cfg, aug=cfg.train_aug, mode="val")
...
# model = CustomTransformerEncoder(cfg.n_landmark,
#                                 cfg.d_model,
#                                 cfg.num_layers,
#                                 cfg.num_classes,
#                                 cfg.num_heads,
...
for epoch in range(cfg.epochs):
    ...
    for inputs, labels in tqdm(train_dataloader, desc=f'Epoch {epoch + 1}/{cfg.epochs}', unit='batch'):
        ...
        train_acc_list.append(get_accuracy(model,val_dataloader))
        n += 1
